...
public class TransactionRepoTest {
        ...
        @BeforeEach
        void setUp() {
            user = userRepo.getUserByEmail("test@example.com")
                    .orElseGet( () -> {
                        User u = new User();
    ...
    void testGetMonthlyIncomeForYear() {
        ...
        BigDecimal expectedSum = expectedMonthlyIncome.stream()
        ...
        List<BigDecimal> monthlyIncomeForYear =  transactionRepo.getMonthlyIncomeForYear(user.getId(), thisYear);
    ...
    void testFindTop5CategoriesByAmount() {
        ...
        List<ExpenseAnalysis> actualCategories =  transactionRepo.findTop5CategoriesByAmount(user.getId());
