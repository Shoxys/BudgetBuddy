...
public class TransactionServiceTest {
  ...
  void getTransactionsByUserIdPaginated_shouldReturnTransactions() {
    ...
    Page<Transaction> mockPage =
        new PageImpl<>(mockTransactions, PageRequest.of(page, size), mockTransactions.size());

    when(userRepo.existsById(mockUser.getId())).thenReturn(true);
    when(transactionRepo.findByUser_Id(mockUser.getId(), PageRequest.of(page, size)))
        .thenReturn(mockPage);
