...
class AccountServiceTest {
  ...
  public void getAccountsByUserId_shouldThrowIfUserNotFound() {
    ...
    assertThrows(
        UserNotFoundException.class, () -> accountService.getAccountsByUserId(INVALID_USER_ID));
  }
  ...
  public void upsertAccountBalance_shouldUpdateBalanceIfFound() {
    ...
    Account resultAccount =
        accountService.upsertAccountBalance(
            VALID_EMAIL, expectedAccount.getName(), expectedAccount.getType(), expectedNewBalance);
  ...
  public void upsertAccountBalance_shouldThrowIfUserNotFound() {
    ...
    assertThrows(
        ...
        () ->
            accountService.upsertAccountBalance(
                INVALID_EMAIL,
                expectedAccount.getName(),
                expectedAccount.getType(),
                mockNewBalance));
  }
