...
class AccountControllerTest {
  ...
  void testUpdateSavings() throws Exception {
    ...
    UpdateAccountRequest request =
        new UpdateAccountRequest("My Savings", AccountType.SAVINGS, BigDecimal.valueOf(10000));
    ...
    mockMvc
        .perform(
            post("/api/account/update-savings")
  ...
  void testUpdateInvestments() throws Exception {
    UpdateAccountRequest request =
        new UpdateAccountRequest("Stocks", AccountType.INVESTMENTS, BigDecimal.valueOf(10000));
    ...
    mockMvc
        .perform(
            post("/api/account/update-investments")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(request)))
        .andExpect(status().isOk());
