...
public class DashboardControllerTest {
  ...
  void setUp() {
    ...
    DashboardResponse partialResponse =
        new DashboardResponse(
            BigDecimal.valueOf(1000), List.of(), null, null, null, null, null, null, null);
  ...
  void testGetDashboardData_Returns200AndPartialResponse() throws Exception {
    mockMvc
        .perform(get("/api/dashboard/data").contentType(MediaType.APPLICATION_JSON))
        .andDo(print())
