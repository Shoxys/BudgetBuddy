...
public class UserSettingsControllerTest {
  ...
  void testChangePassword() throws Exception {
    ...
    verify(userService, times(1))
        .changePassword(eq("test@example.com"), any(ChangePasswordRequest.class));
  }
  ...
  void testUpdateEmail() throws Exception {
    ...
    verify(userService, times(1))
        .updateEmail(eq("test@example.com"), any(UpdateEmailRequest.class));
  }

  @Test
  void testDeleteAccount() throws Exception {
    mockMvc.perform(delete("/api/settings/delete-account")).andExpect(status().isOk());
