...
public class AiInsightService {
  ...
  public String getInsightsFromText(String promptText) {
    ...
    try {
      GeminiResponse response =
          restTemplate.postForObject(apiUrl, requestEntity, GeminiResponse.class, model);
      if (response != null) {
  ...
  public List<SpendingInsight> parseInsightsToList(String rawInsights) {
    ...
    List<SpendingInsight> insights =
        Arrays.stream(rawInsights.split("\n"))
  ...
  private List<SpendingInsight> getStaticInsights() {
    ...
    return List.of(
        new SpendingInsight(
            "Regularly reviewing your spending is a great first step to finding savings!"),
