...
public class AccountController {
  ...
  public ResponseEntity<BigDecimal> getAccountBalance(
    ...
    String username = userDetails.getUsername();
    logger.info("Fetching balance for user: {}, account: {}, type: {}", username, name, accountType);
    try {
      ...
      logger.info("No balance found for user: {}, account: {}, type: {}. Returning zero", username, name, accountType);
      return ResponseEntity.ok(BigDecimal.ZERO);
    } catch (Exception e) {
      logger.error("Failed to retrieve balance for user: {}, account: {}, type: {}", username, name, accountType, e);
      throw e;
    }
  }
}