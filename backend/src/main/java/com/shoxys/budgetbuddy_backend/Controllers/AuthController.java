...
public class AuthController {
  ...
  public ResponseEntity<RegisterResponse> register(
    ...
    try {
      ...
      logger.error(
          "Server error during registration for email {}: {}", request.getEmail(), e.getMessage());
      return ResponseEntity.internalServerError()
          .body(new RegisterResponse("Server error occurred", false));
    }
  }
  ...
  public ResponseEntity<AuthResponse> login(
    ...
    try {
      ...
      logger.error(
          "Server error during login for email {}: {}", request.getEmail(), e.getMessage());
      return ResponseEntity.internalServerError()
          .body(new AuthResponse(null, "Server error occurred"));
    }
  }
  ...
  public ResponseEntity<String> logout(HttpServletResponse response) {
    ...
    ResponseCookie cookie =
        ResponseCookie.from(Constants.JWT_COOKIE_NAME, null)
  ...
  private void addJwtCookie(HttpServletResponse response, String jwtToken) {
    ResponseCookie cookie =
        ResponseCookie.from(Constants.JWT_COOKIE_NAME, jwtToken)
            .httpOnly(Constants.COOKIE_HTTP_ONLY)
            .secure(Constants.COOKIE_SECURE)
            .path(Constants.COOKIE_PATH)
