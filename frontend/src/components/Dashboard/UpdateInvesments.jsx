...
export default function UpdateSavings({ isOpen, onClose }) {
  const [investments, setInvestments] = useState(1232);
    ...
    <Dialog open={isOpen} onClose={onClose} className="relative z-50">
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4 font-body">
        <Dialog.Panel className="w-full max-w-md rounded-lg bg-white p-6 shadow-lg">
          <Dialog.Title className="text-lg font-semibold font-header mb-2">Update Investments</Dialog.Title>
          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                  type="number"
                  value={investments}
                  onBlur={(e) => setInvestments(formatMoney(e.target.value))}
